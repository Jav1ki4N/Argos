...
/*===================================================*/
/*       i4n@2026 | ddc_spi_device | 2026-4-26       */
/*       SPI device abstraction wrapper class       */
/*===================================================*/
/* Purpose: Encapsulate a single SPI device on an     */
/*          SPI bus, handling device creation and     */
/*          teardown, plus optional CS pin ownership. */
/*===================================================*/
#pragma once
/* Includes --------------------------------------------------------------- */
#include "ddc_io.hpp"
